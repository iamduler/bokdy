...
func ActionForEvent(eventType string) string {
	switch eventType {
	case "UserRegistered", "OrganizationCreated", "StaffAdded", "InvitationCreated", "GuestCustomerCreated", "CustomerRegistered", "BookingCreated", "InvoiceIssued", "ReservationCreated", "BranchCreated", "CourtTypeCreated", "CourtCreated", "TimeBlocked", "PricingVersionCreated", "PaymentCreated", "PaymentRefunded":
		return "created"
	...
	case "UserVerified", "OrganizationActivated", "OrganizationSuspended", "OrganizationRestored", "StaffSuspended", "StaffRestored", "BranchOpened", "BranchClosed", "BranchArchived", "InvitationRejected", "InvitationExpired", "CustomerBlacklisted", "CustomerRestored", "CourtTypeArchived", "CourtOpened", "CourtClosed", "CourtArchived", "CourtMaintenanceScheduled", "CourtMaintenanceCompleted",
		...
		"PaymentSucceeded", "PaymentFailed", "PaymentExpired", "InvoicePaid", "InvoiceVoided":
		return "status_change"
	case "UserLoggedIn", "UserLoginFailed", "SessionRefreshed":
		return "login"
	case "UserLoggedOut":
		return "logout"
	case "StaffRemoved", "InvitationRevoked", "RoleRemoved", "TimeUnblocked", "PricingVersionArchived":
		return "deleted"
